...
const osThreadAttr_t taskGlcdRender_attributes = {
  .name = "taskGlcdRender",
  .stack_size = 128 * 4,
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : MUX_EN_OG_KBD_COL_Pin MUX_EN_KBDV_ROW_Pin MUX_EN_KBDV_COL_Pin MUX_EN_KEY_ROW_Pin
                           MUX_EN_KEY_COL_Pin */
  GPIO_InitStruct.Pin = MUX_EN_OG_KBD_COL_Pin|MUX_EN_KBDV_ROW_Pin|MUX_EN_KBDV_COL_Pin|MUX_EN_KEY_ROW_Pin
                          |MUX_EN_KEY_COL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
