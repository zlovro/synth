##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.5.0-RC5] date: [Tue Jul 15 12:40:39 CEST 2025] 
##########################################################################################################################
...
# target
######################################
TARGET = synth-h743vit6-makefile
...
Core/Inc/sfs/sfs.c \
Core/Inc/solfege/solfege.c \
Core/Inc/sinf/serrno.c \
Core/Inc/glcd/glcd.c \
Core/Inc/glcd/glcd_font.c \
Core/Inc/ssys/ssys.c \
Core/Inc/splayer/splayer.c \
Core/Inc/smidi/smidi.c \
Core/Inc/sser/sser.c \
Core/Inc/freeverb/freeverb.c \
...
CFLAGS += -MMD -MP -MF"$(@:%.o=%.d)" -Werror -pedantic -std=c2x -Wno-discarded-qualifiers -std=c2x
